        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 py-6 md:py-10">
          ...
          <section className="w-full relative bg-black overflow-hidden pb-0 mb-0">
            <div className="grid grid-cols-1 md:grid-cols-2 h-full gap-12 md:gap-8">
              ...
              <div className="flex flex-col justify-center items-start space-y-8 z-10 relative h-full text-left order-2 md:order-1 pr-4 md:pr-16 lg:pr-20">
                ...
                <p className="text-gray-400 text-lg md:text-xl max-w-md">
                  {personal.name}. Multidisciplinary designer merging motion graphics and interactive digital experiences to elevate high-impact campaigns.
                </p>
              ...
              <div className="relative h-[60vh] md:h-full w-full order-1 md:order-2 bg-black overflow-hidden flex justify-center items-end will-change-transform pb-0 mb-0">
